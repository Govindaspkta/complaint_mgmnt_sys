...
#          def get(self, request):
#             profiles =AetherixComplaints.objects.filter(
...
#         # Use your existing ComplaintSerializer
#         serializer = ComplaintSerializer(
#             complaint, 
#             data=request.data, 
#             partial=True,
...
#             # Handle status update using your ComplaintStatusChoices
#             new_status = request.data.get('status')
#             if new_status:
#                 # Normalize to uppercase to match your choices
...
#                 else:
#                     return self.error(
#                         f"Invalid status. Valid options: { [choice[0] for choice in ComplaintStatusChoices.choices] }", 
#                         status_code=400
#                     )

#             refreshed_serializer = ComplaintSerializer(
#                 updated_complaint, 
#                 context={'request': request}
#             )
