...
// import { getComplaintDetail, deleteComplaint } from '../api/complaintApi';
// import { updateComplaintAdmin } from './../api/complaintApi'; // reuse for user update
...
//   const canEdit = complaint && (complaint.status === "REJECTED" || complaint.complaint_status === "REJECTED");

//   const handleUpdate = async () => {
//     try {
//       await updateComplaintAdmin(reference_id, formData); // or create separate user update API
...
//           </div>
//           <span className={`px-5 py-2 rounded-full text-sm font-medium ${getStatusBadge(complaint.status || complaint.complaint_status)}`}>
...
//               className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-medium flex items-center justify-center gap-2"
//             >
//               <Edit size={20} /> {isEditing ? "Cancel Edit" : "Edit Complaint"}
//             </button>

//             <button
//               onClick={handleDelete}
//               className="flex-1 bg-red-600 hover:bg-red-700 text-white py-4 rounded-2xl font-medium flex items-center justify-center gap-2"
//             >
...
//             <h3 className="font-semibold mb-4">Update Complaint</h3>
//             {/* Add form fields here for editing */}
//             <button onClick={handleUpdate} className="w-full bg-green-600 text-white py-4 rounded-2xl">
//               Save Updates (Status will go to PENDING)
//             </button>
//           </div>
//         )}
//       </div>
